export default {
  ...
  settings: {
    ...
    appearance: {
      ...
      accentColorDesc: 'La sélection de la couleur d\'accent est réservée dans le prototype, pas encore enregistrée dans les paramètres.',
      ...
      stickyNoteDesc: 'La couleur du papier des nouvelles notes sera intégrée aux cartes du canevas dans les versions futures.',
      planned: 'Planifié',
    },
    shortcuts: {
      title: 'Raccourcis',
    ...
    todo: {
      ...
      enabledDesc: 'Lorsque désactivé, le raccourci système sera désenregistré et le panneau ne pourra pas être affiché.',
      shortcut: 'Raccourci',
      shortcutDesc: 'Appuyez directement sur les combinaisons de touches ; les raccourcis système seront réenregistrés.',
    ...
    privacy: {
      ...
      dbEncryptionDesc: 'L\'entrée de chiffrement SQLCipher est prévue ; la version actuelle ne modifie pas la structure de la base de données.',
      sensitiveFilter: 'Filtre de contenu sensible',
      sensitiveFilterDesc: 'Le filtrage par motif des numéros de carte de crédit, jetons et clés privées nécessite un support de règles backend.',
      appExclusion: 'Liste d\'exclusion d\'applications',
      appExclusionDesc: 'Les gestionnaires de mots de passe et les listes d\'exclusion d\'applications désignées seront intégrés au niveau de la couche de permissions.',
