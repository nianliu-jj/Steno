...
function formatSection(
  ...
  const scopes = groupBy(commits as unknown as Array<Record<string, unknown>>, 'scope') as unknown as Record<string, GitCommit[]>;
...
export async function generateMarkdown(params: {
  ...
  const group = groupBy(changes as unknown as Array<Record<string, unknown>>, 'type') as unknown as Record<string, GitCommit[]>;
